    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {tareas.length === 0 ? (
        <div className="flex justify-center pt-1">
          <div className="w-full max-w-xl flex flex-col items-center justify-center py-10 px-8 bg-slate-800/50 border border-slate-700/50 rounded-lg">
            <CheckCircle2 className="w-6 h-6 text-slate-500 mb-3" />
            <h3 className="text-white font-semibold text-lg mb-5">No tenés nada pendiente</h3>
...
function TarjetaTarea({ tarea, miEmpleadoId }: { tarea: Tarea; miEmpleadoId: string | null }) {
  ...
  return (
    <div className={`card p-5 space-y-4 transition-all duration-200 hover:shadow-lg hover:shadow-black/20 hover:scale-[1.01] cursor-pointer  ${vencida ? 'border-l-4 border-l-red-500' : ''}`}>
